...
def write_config(name, value):
	...
	"current_group": config["current_group"], "groups": config["groups"], "group_pwds": config["group_pwds"],
	"country": config["country"], "scroll": config["scroll"], "refresh": config["refresh"], "tab": config["tab"], "token": config["token"], 
	"achievement": config["achievement"], "sortby": config["sortby"], "hidden_users": config["hidden_users"], "homescreen": config["homescreen"],
